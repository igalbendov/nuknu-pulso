...
export const CATEGORIES = [
  { key: "importante", label: "Importante", color: "var(--red)",    soft: "rgba(239,68,68,.16)" },
  { key: "tienda",     label: "Tienda",     color: "var(--green)",  soft: "rgba(34,197,94,.16)" },
  { key: "promo",      label: "Promo",      color: "var(--amber)",  soft: "rgba(245,158,11,.16)" },
  { key: "general",    label: "General",    color: "var(--accent)", soft: "rgba(110,168,254,.16)" },
];
...
export const SEED_NEWS = [
  {
    ...
    autor: "Igal",
    cat: "importante",
    text: "Este fin de semana hacemos 2x1 en accesorios (sábado y domingo). Los carteles llegan mañana a las dos tiendas. Aplicar desde la apertura 🙌",
    min: 55,
    likes: 4,
  },
  {
...
const AV_COLORS = ["#6ea8fe", "#22c55e", "#f59e0b", "#a78bfa", "#38bdf8", "#ec4899", "#14b8a6", "#f97316"];
